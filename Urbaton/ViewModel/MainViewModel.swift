    ...
    @Published
        ...
        func login(login: String, password: String) {
            ...
            DispatchQueue.global(qos: .userInitiated).async {
                Requester.shared.login(authBody: AuthBody(email: login, password: password)) { [self] result in
        ...
        func register(login: String, password: String) {
            ...
            DispatchQueue.global(qos: .userInitiated).async {
                Requester.shared.register(authBody: AuthBody(email: login, password: password)) { [self] result in
